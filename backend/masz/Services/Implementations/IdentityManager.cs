...
namespace MASZ.Services
{
    public class IdentityManager : IIdentityManager
    {
        ...
        public IdentityManager(ILogger<IdentityManager> logger, IEventHandler eventHandler, IServiceProvider serviceProvider, IServiceScopeFactory serviceScopeFactory)
        {
            _logger = logger;
